...
export function LoginModal({}: Props) {
  ...
  return (
    <>
      {showLoginModal &&
        (showSocialLogin ? (
          <SocialLoginModal setShowCreateAccount={setShowCreateAccount} setShowSocialLogin={setShowSocialLogin} />
        ) : showCreateAccount ? (
          <CreateAccountModal setShowCreateAccount={setShowCreateAccount} setShowSocialLogin={setShowSocialLogin} />
        ) : (
          <div
              ...
              <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <form className="px-6 pb-4 space-y-6 lg:px-8 sm:pb-6 xl:pb-8" action="#">
                  <div className="flex flex-col">
                    <h3 className="text-2xl font-medium text-gray-900 dark:text-white self-center">Log in</h3>
                  </div>
                  <div>
