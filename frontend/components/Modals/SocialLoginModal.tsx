...
export function SocialLoginModal({ setShowCreateAccount, setShowSocialLogin }: Props) {
  ...
  const handleGithubAuth = async () => {
    window.open(`${urlBase}/auth/github`, "_self");
  };
          ...
          <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div className="p-6 pt-0">
              <div className="flex text-center">
                <h2 className="text-2xl font-normal text-gray-500 dark:text-gray-400">Join and sell pre-loved clothes with no fees</h2>
              </div>
              <ul className="my-4 space-y-3">
                <li>
                  <a
                    className="flex items-center p-3 cursor-pointer text-base font-bold text-gray-900 bg-gray-50 rounded-lg hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white"
                  ...
                  >
                    ...
                    <span className="flex-1 ml-3 whitespace-nowrap">Continue with Google</span>
                  </a>
                </li>
                <li>
                  <a
                  ...
                  >
                    ...
                    <span className="flex-1 ml-3 whitespace-nowrap">Continue with Facebook</span>
                  </a>
                </li>
                <li>
                  <a
                  ...
                  >
                    ...
                    <span className="flex-1 ml-3 whitespace-nowrap">Continue with GitHub</span>
                  </a>
                </li>
              </ul>
              <div className="flex text-center flex-col">
                <div className="text-sm font-medium text-gray-500 dark:text-gray-300">
                  <a onClick={handleRegisterClick} className="text-blue-700 hover:underline cursor-pointer dark:text-blue-500">
                    Register
                  </a>{" "}
                  or{" "}
                  <a onClick={() => setShowSocialLogin(false)} className="text-blue-700 hover:underline cursor-pointer dark:text-blue-500">
                    {" "}
                    Log in{" "}
                  </a>{" "}
                  with your email
